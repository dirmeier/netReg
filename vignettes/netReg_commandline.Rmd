...
If something is unclear/buggy/not working I am glad to take any questions.
...
Then download the tarball of the latest [release](https://github.com/dirmeier/netReg/releases/). We use `CMake` for building the package. You build the package like this:
...
This gives a list of required arguments which I think are rather self explanatory, but we will look at some examples later.
