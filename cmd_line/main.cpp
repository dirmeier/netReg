...
//             (",o", boost::program_options::value<decltype(out_filename)>(
...
//                   &nfolds)->default_value(10, "10"),
//               "The number of cross-validation folds. "
//                   "This can be maximal the number of rows of X/Y and minimal 3.")
//              ("threshold,t",
//               boost::program_options::value<decltype(threshold)>(
//                   &threshold)->default_value(0.0000001, "0.0000001"),
