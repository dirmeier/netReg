       ...
       public:
        ...
        edgenet_binomial_loss_function(
          graph_penalized_linear_model_cv_data &data)
            : data_(data), cvset_(data.cvset()), X_(data.design()),
              Y_(data.response()),
        ...
        double operator()(const dlib::matrix<double> &p) const
        {
            ...
            //                {
            //                    coef = edgenet_.run_cv(data_, p(0, 0), 1.0,
            //                    p(1, 0),
            //                                           p(2, 0), fold);
            //                }
            //                else if (do_psigy_)
            //                {
            //                    coef = edgenet_.run_cv(data_, p(0, 0), 1.0, 0,
            //                    p(2, 0),
            //                                           fold);
            //                }
            //                else if (do_psigx_)
            ...
            //                sses[fc] = err;
            //            }
            //            double  err = std::accumulate(sses.begin(),
            //            sses.end(), 0.0);
            //            return err;
            return 0.0;
        }
